...
import { IconFlame, IconAlertTriangle, IconEye, IconCircleCheck, IconCircleOff } from '@tabler/icons-react';
                  ...
                  <div className='flex flex-wrap gap-x-4 gap-y-1 pt-2 text-xs'>
                    ...
                    {f.fireCount > 0 && (
                      <>
                        ...
                        <span className='text-red-400'>CO₂: {formatCO2(f.totalCO2)} t/day</span>
                      </>
                    )}
                  </div>
                </CardContent>
